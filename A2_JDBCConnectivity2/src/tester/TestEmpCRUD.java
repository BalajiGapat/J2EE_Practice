	...
	public static void main(String[] args) 
	{
		try (Scanner sc = new Scanner(System.in)) 
		{
			...
			while (!exit) 
			{
				...
				System.out.println("2. Insert Emp details");
				System.out.println("3.Update Emp Details");
				System.out.println("4. Delete Emp Details");
				System.out.println("5. Display avg sal by dept");
				...
				try 
				{
					...
					case 1: // get emp details
						...
						break;
					case 2:
						System.out.println("Enter emp details : name | address | salary | deptid | join_date(yr-mon-day)");
