...
public class FakeUserService 
{
	...
	static
	{
		list.add(new User("Balaji", "Balaji@123", "balaji@gmail.com"));
		list.add(new User("Abhijit", "abhijit@123", "abhijit@gmail.com"));
		list.add(new User("Akash", "akash@123", "akash@gmail.com"));
		list.add(new User("Saurabh", "saurabh@123", "saurabh@gmail.com"));
	}
